 ...
 */
class Xliff12AdapterTest : AbstractAdapterTest<Xliff12Adapter>() {

    @Before
    fun setup() {
        adapter = Xliff12Adapter()
    }
...
<xliff xmlns="urn:oasis:names:tc:xliff:document:1.2" version="1.2">
    ...
    @Test
    fun testTranslatedXliff12Document() {
        testTranslatedXliff12Document(false)
    }

    @Test
    fun testTranslatedXliff12DocumentApprovedOnly() {
        testTranslatedXliff12Document(true)
    }
...
<xliff xmlns="urn:oasis:names:tc:xliff:document:1.2" version="1.2">
    <file datatype="x-unknown" original="en.properties" source-language="en" target-language="fr">
        ...
        """.trimIndent()) { originalFile ->
            ...
            <?xml version="1.0" encoding="UTF-8"?>
            <!DOCTYPE Xliff12 []>
            <Xliff12 version="2.1" language="mo-PH">
            <context>
